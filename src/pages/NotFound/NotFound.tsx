    ...
    <div className="flex h-screen w-screen items-center bg-gray-100">
      <div className="container flex flex-col items-center justify-center px-5 text-gray-700 md:flex-row">
        <div className="max-w-md">
          ...
          <Link
            to={path.home}
            className="focus:shadow-outline-orange inline rounded-lg border border-transparent bg-orange px-5 py-3 text-sm font-medium leading-5 text-white shadow transition-colors duration-150 hover:bg-orange/80 focus:outline-none active:bg-orange/80"
          >
            Back to homepage
          </Link>
        </div>
