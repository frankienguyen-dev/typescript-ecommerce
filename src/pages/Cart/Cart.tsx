...
export default function Cart() {
  ...
  const totalPriceCheckedPurchases = checkedPurchases.reduce((result, current) => {
    return (result + current.product.price) * current.buy_count
  }, 0)

  const totalDiscountPriceCheckedPurchases = checkedPurchases.reduce((result, current) => {
          ...
          <div className='mt-5 flex flex-col items-center justify-center sm:ml-auto sm:mt-0 sm:flex-row'>
            <div>
              <div className='flex items-center justify-center sm:flex-row sm:justify-end'>
                ...
                <div className='ml-2 text-2xl text-orange'>₫{formatCurrency(totalPriceCheckedPurchases)}</div>
              </div>

              <div className='flex items-center justify-center text-sm sm:justify-end'>
                <div className='text-gray-500'>Tiết kiệm:</div>
                <div className='ml-6 text-orange'>₫{formatCurrency(totalDiscountPriceCheckedPurchases)}</div>
              </div>
            </div>
