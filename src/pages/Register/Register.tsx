...
export default function Register() {
  ...
  const registerAccountMutation = useMutation({
    mutationFn: (body: Omit<formData, 'password_confirm'>) => authApi.registerAccount(body)
  })
  ...
  const onSubmit = handleSubmit((data) => {
    ...
    registerAccountMutation.mutate(body, {
      ...
      onError: (error) => {
        if (axiosUnprocessableEntityError<ErrorResponse<Omit<formData, 'password_confirm'>>>(error)) {
